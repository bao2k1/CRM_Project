                                            ...
                                            <tr>
                                               ...
                                               <td>
                                                    <c:forEach var="role" items="${listRole}">
                                                        ...
                                                        <!-- Thực hiện các thao tác khác với giá trị roleId và roleName -->
                                                        <c:if test="${item.getRoleId() ==role.getId()}">
                                                        			${role.getDesc()}
                                                        </c:if>
                                               ...
                                               <td>
                                                   <a href=""<c:url value="/user/edit/${item.getId()}"/>"" class="btn btn-sm btn-primary">Sửa</a>
                                                  <span userid="${item.getId()}" class="btn-delete-user btn btn-sm btn-danger">Xóa</span>
                                                   <a href="<c:url value="/user/detail/${item.getId()}"/>" class="btn btn-sm btn-info">Xem</a>
                                               </td>
                                            </tr>
                                        </c:forEach>
